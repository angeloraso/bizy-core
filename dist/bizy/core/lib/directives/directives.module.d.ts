...
import * as i1 from "./copy-to-clipboard.directive";
import * as i2 from "./currency-format.directive";
import * as i3 from "./loading.directive";
import * as i4 from "./long-press.directive";
import * as i5 from "./only-numbers.directive";
import * as i6 from "./only-phone-digits.directive";
