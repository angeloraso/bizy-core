...
import { RendererFactory2, Injectable, Inject, EventEmitter, ElementRef, Renderer2, Directive, Output, HostListener, NgModule, ChangeDetectorRef, ViewContainerRef, Component, ChangeDetectionStrategy, ViewChild, Pipe } from '@angular/core';
